...
import 'package:nihaljumailamrathaju/additem/sweetsdetailspage.dart';

class Sweetslistview extends StatefulWidget {
  const Sweetslistview({super.key});

  @override
  State<Sweetslistview> createState() => _SweetslistviewState();
}

class _SweetslistviewState extends State<Sweetslistview> {
  @override
